...
function renderExtractionReview(data) {
  ...
  if (data.needs_clinician_confirmation) {
    ...
    alertBox.innerHTML = `⚠️ <strong>Clinician Confirmation Required:</strong> Extracted prescription contains ambiguous or missing dosing/duration fields. Please review carefully before executing safety rules.`;
